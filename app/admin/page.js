    ...
    <div className="min-h-screen bg-zinc-950 text-white font-sans p-6 md:p-10 selection:bg-purple-500/30">
      <header className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
        ...
        <div className="flex items-center gap-4">
          <img src="/favicon/android-chrome-192x192.png" alt="KL Logo" className="w-12 h-12 rounded-xl shadow-lg shadow-purple-500/10" />
          <div>
            <h1 className="text-3xl font-black bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent uppercase italic">KL RESUME ADMIN</h1>
